...
def mint(network='mumbai', amount0ToMint=0.02*10**TOKEN0_DECIMAL_MUMBAI, amount1ToMint=0.0001*10**TOKEN1_DECIMAL_MUMBAI,\
    ...
    #N.B. If .wait_for_transaction_receipt() hangs, it exits after TIMEOUT_SEC with web3.exceptions.TimeExhausted and succedes on the next iteration 
    ...
    try:
        #N.B. Tx cancels after deadline, so no point of waiting TIMEOUT_SEC! https://docs.uniswap.org/contracts/v3/guides/swaps/single-swaps
