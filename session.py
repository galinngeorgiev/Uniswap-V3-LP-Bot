...
class Session():
    def __init__(self, network, address, init):
        ...
        self.swap_cost_bp, self.res_num_token0, self.res_num_token1 =  0., 0., 0.
    ...
    def report(self, address, startBlockNumber, start_time, max_price_mad):
        ...
        logger.info(self.network + ", session" +  ": res num token0 = " + str(self.res_num_token0) + ' ' + self.init.token0_symbol +\
            ", res num token1 = " + str(self.res_num_token1) + ' ' + self.init.token1_symbol)
