...
if TEST:
	...
	NUM_LP, RUNTIME_SEC = 1, 1800 #N.B. Running time of the loop (loop runs longer because tx executions take time)
	assert NUM_LP % 2 == 1
	...
	LP_SWAP, LP_SWAP_MULT_RUNTIME, LP_SWAP_DISTANCE_TO_BOUND_PER, LP_SWAP_UNWIND_DISTANCE_PER, LP_SWAP_MAX_ATTEMPTS_FAILED_TX = False, 2, 0.05, 0.2, 2 #N.B. Execute swaps with LP;
