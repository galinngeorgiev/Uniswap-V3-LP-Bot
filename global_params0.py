...
if TEST:
	...
	DELAY_LOOP_SEC = 1
	EXPIRY_SEC, TIMEOUT_SEC = 30, 900 #N.B. 1st is used for deadline (cancel after) in mint, decreaseLiquidity, swap; 2nd is used in .wait_for_transaction_receipt (if TIMEOUT_SEC=0,  w3.eth.wait_for_transaction_receipt returns error TimeExhausted)
