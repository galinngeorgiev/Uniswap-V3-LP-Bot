...
if TEST:
	...
	LP_DISTANCE_TO_BOUND_PER, UNWIND_DIST_TO_BOUND_PER = [50, 70], 5
	...
	LP_DISTANCE_TO_BOUND_PER, UNWIND_DIST_TO_BOUND_PER = [0.25, 0.25], -10000 #[0.2, 0.2], 5
	...
	MIN_SESSION_SWAP_PER, MIN_TX_SWAP_PER = 10000, 10000 #N.B. execute swaps only if amount_to_swap >; in percent of 2 * MAX_NUM_TOKEN0_LP
