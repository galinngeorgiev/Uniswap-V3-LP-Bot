...
if TEST:
	...
	MIN_SESSION_SWAP_PER, MIN_TX_SWAP_PER, SWAP_EPSILON_PER = 10000, 0, 0 #N.B. execute swaps only if amount_to_swap >; in percent of 2 * MAX_NUM_TOKEN0_LP
	...
	UNWIND_DIST_TO_BOUND_PER = - 2 * NUM_LP * 100 #-10000 #5 #N.B. Unwind all NUM_LP tx-s if < min(dist-to-lower-bound, dist-to-upper-bound) is lower!
