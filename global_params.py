...
LP_DISTANCE_TO_BOUND_PER = [0., 0.] #if 0., price range is the minimum # ticks > 0, determined by the pool (fee); 2-nd entry in the list is for begining-to-end of quiet hours, 1-st entry in list otherwise!
LP_BOUND_DISTANCE_TO_CURRENT_PER =  [0.4, 1.] #min (1st) and max (2nd) of lp_bound_distance_to_current_per
...
if CHANGE_LP_POSITION_TO_INIT_PRICE:
        ...
        LP_SWAP, LP_SWAP_MULT_RUNTIME, LP_SWAP_DISTANCE_TO_BOUND_PER, LP_SWAP_UNWIND_DISTANCE_PER, LP_SWAP_MAX_ATTEMPTS_FAILED_TX = False, 2, 0.1, 0.2, 1
