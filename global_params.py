...
LP_BOUND_DISTANCE_TO_CURRENT_PER =  [0.2, 1.] #min (1st) and max (2nd) of lp_bound_distance_to_current_per
...
assert LP_SWAP_DISTANCE_TO_BOUND_PER <= LP_SWAP_UNWIND_DISTANCE_PER
if LP_SWAP_DISTANCE_TO_BOUND_PER == LP_SWAP_UNWIND_DISTANCE_PER:
	assert LP_SWAP_DISTANCE_TO_BOUND_PER == 0. #N.B. Otherwise LP swaps unwin immediately!
