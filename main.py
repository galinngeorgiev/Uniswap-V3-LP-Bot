...
def main(network='mumbai'):
    ...
    #initialize tx
    i, block_num, CEX_price_list, price_list, price, price_list_median, price_median, price_mad, max_price_mad_time, swap_price, pos_price_mad, avg_price_mad, max_price_mad =\
    ...
    tokenIds, tokenIds_burned, liquidities, unwind_distance_to_bound = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], [],  ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None]
    amount0_LP, amount1_LP, priceLower, tickLower, priceUpper, tickUpper, priceLP, LP_position_to_init_price =\
            ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None],\
            ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None],  ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [INIT_LP_POSITION_TO_INIT_PRICE]
    swap_volume_token1, rel_swap_volume_token1, swap_flow_token1 = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.]
    amount0_invested, amount1_invested, asset_ratio_01_LP, asset_ratio_01, asset0_ratio, asset1_ratio =\
            ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None]
    tx_invested_token1, tx_token1_rf_invested_token1, tx_collected_token1 =\
            ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.] , ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.]
    tx_invested, tx_collected = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [(0., 0.)], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [(None, None)]
    tx_token0_rf_pl_token1, tx_token0_rf_pl_bp, tx_token1_rf_pl_token1, tx_token1_rf_pl_bp, tx_estimated_token1_rf_pl_bp =\
            ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.] , ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.]
    RL_v2_token1, RL_v2_bp, v3_v2_mult_factor, RL_v3_token1, RL_v3_bp, LP_fees_bp, OTM_loss_token1, OTM_loss_bp =\
            ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.],  ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.]
    #tx_count_hedge_RL, tx_hedge_RL_amount, last_RL_bp, tx_hedge_RL_pl_bp, hedge_RL_pl_bp =\
    #    ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.]
    amount_to_swap_token0, tx_batch_amount_to_swap_token0 = 0., 0.
    mint_time, duration, ITM_duration, OTM_duration, decreaseLiquidity_time, burn_time =\
       ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0.], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [0], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None]
    mint_condition, unwind_condition = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [False], ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [False]
    count_LP_swap_attempts, count_failed_tx, count_failed_price, count_failed_token, count_times_increase_NUM_LP = 0, 0, 0, 0, 0
    ...
    #N.B. Run current_price() in order to get startBlockNumber
    result = current_price(network, block_num, CEX_price_list, price_list, price_list_median, pool_liquidity_list, pool_liquidity_median, \
                price_mad, pos_price_mad, avg_price_mad, max_price_mad, priceLower, priceUpper, swap_volume_token1, rel_swap_volume_token1, swap_flow_token1, PRICE_ALCHEMY, init=init)      
    if isinstance(result, list):
        count_failed_price = 0
        GMTtimeStamp, block_num, txIx, CEX_price_list, CEX_size, CEX_bid, CEX_ask, price_list, price_list_median, pool_liquidity_list, pool_liquidity_median, signed_token1_quantity,\
                        price_mad, pos_price_mad, avg_price_mad, max_price_mad, swap_volume_token1, rel_swap_volume_token1, swap_flow_token1 = result

        #N.B. Used in current_LP_positions()
        startBlockNumber = block_num
    logger.info(network + ', startBlockNumber = ' + str(startBlockNumber))
    #N.B. initialize lp_bound_distance_to_current_per at min
    lp_bound_distance_to_current_per = LP_BOUND_DISTANCE_TO_CURRENT_PER[0]
    logger.info(network + ', start lp_bound_distance_to_current_per = ' + "{:1.1f}".format(lp_bound_distance_to_current_per))
    ...
    while i <= main_loop_end:
        ...
        #N.B. If num swaps / num non-swap LP > 0.5, increase twice NUM_LP
        if sum(session.count_LP[:NUM_LP]) > 2 * NUM_LP and priceLP[NUM_LP] is None and count_times_increase_NUM_LP < MAX_TIMES_INCREASE_NUM_LP:
            if ((session.count_LP_swap - session.count_LP_swap_failed) + session.count_conventional_swaps) / sum(session.count_LP[:NUM_LP]) >= 1.:
                count_times_increase_NUM_LP += 1
                NUM_LP *= 2
                logger.info(network + ', increase NUM_LP to ' + str(NUM_LP) + ' because num non-swap LP > ' + str(2 * NUM_LP) +\
                            ' and num swaps / num non-swap LP >= 0.5!')
        
        if tokenIds == ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None]:
            logger.info(network + ', flag_unwind = False because tokenIds == ' + str((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) + ' * [None]')
            flag_unwind = False
        ...
        #N.B. current_LP_positions() is before current_price() because the latter sometimes increases i!
        ...
        if (not flag_failed_tx) and (flag_change_tokenIds or i % PERIOD_CURRENT_LP_POSITIONS_ITERATIONS == 0):
            ...
            if isinstance(result, tuple):
                ...
                logger.info(network + ', NUM_LP = ' + str(NUM_LP))
                if TOKEN_ALCHEMY:
                    ...
                    logger.info(network + ', using tokenIds_burned from the code: ' + str(tokenIds_burned))
                    
                    #N.B. Sometimes Polygonscan.com API returns wrong tokenIds_burned, so using the code version
                    ...
                    #    logger.info(network + ', TOKEN_ALCHEMY = True but using tokenIds_burned from ' + init.network_scan + 'API: ' + str(tokenIds_burned))
                ...
                if i % PERIOD_CURRENT_LP_POSITIONS_ITERATIONS == 0:
                    if len(result) != len([tokenId for tokenId in tokenIds if tokenId is not None]):
                        ...
                        logger.error(network + ', > ' + str((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) + ' simultaneous LP positions are NOT allowed, TOKEN_ALCHEMY = not TOKEN_ALCHEMY!')
                        count_failed_token += 1
                        flag_change_tokenIds = True
                        TOKEN_ALCHEMY = not TOKEN_ALCHEMY
                ...
                if i < int(RUNTIME_SEC / DELAY_LOOP_SEC) - NUM_LP * MAX_ATTEMPS_FAILED_TX:
                    logger.info(network + ', current_LP_positions() failed, next main iteration...')
                    i += 1
                    continue
        ...
        if (not flag_failed_tx) or (not flag_mint) or flag_unwind:
            result = current_price(network, block_num, CEX_price_list, price_list, price_list_median, pool_liquidity_list, pool_liquidity_median, \
                     price_mad, pos_price_mad, avg_price_mad, max_price_mad, priceLower, priceUpper, swap_volume_token1, rel_swap_volume_token1, swap_flow_token1, PRICE_ALCHEMY, init=init)      
            if isinstance(result, list):
                count_failed_price = 0
                ...
                #N.B. update lp_bound_distance_to_current_per at every iteration, when current_price() succeeds
                lp_bound_distance_to_current_per = min(max(LP_BOUND_DISTANCE_TO_CURRENT_PER[0], 1000 * avg_price_mad), \
                                                        LP_BOUND_DISTANCE_TO_CURRENT_PER[1])
                logger.info(network + ', lp_bound_distance_to_current_per = ' + "{:1.1f}".format(lp_bound_distance_to_current_per) +\
                    ', avg_price_mad = ' + '{:1.5f}'.format(avg_price_mad))

                if len(CEX_price_list) > 0:
                    CEX_price = CEX_price_list[-1]
                    #logger.info(network + ', CEX_price_list = ' + str(CEX_price_list))
                    if CEX_price is None:
                        CEX_price_list.pop(-1)

                if len(price_list) > 0:
                    price = price_list[-1]
                    if price is None:
                        price_list.pop(-1)
                        logger.info(network + ', price is None, next main iteration...')
                        i += 1
                        continue
                    if price_list_median[-1] == 0.:
                        price_median = price
                elif i < int(RUNTIME_SEC / DELAY_LOOP_SEC) - NUM_LP * MAX_ATTEMPS_FAILED_TX:
                        logger.info(network + ', price_list = [], i before end of loop, next main iteration...')
                        i += 1
                        continue
                
                price_DECIMAL = price * 10**init.token0_decimal / 10**init.token1_decimal
                if len(session.token0_price_collected) > 0:
                    session.token0_pl_token1 = sum(- s[0] / price * (price / s[1] - 1.) for s in session.token0_price_collected)
                if len(session.token0_price_invested) > 0:
                    session.token0_pl_token1 -= sum(- s[0] / price * (price / s[1] - 1.) for s in session.token0_price_invested)
                logger.info(network + ", session: (collected - invested) = (" +\
                        ...
                        "); "+ " (collected - invested) p&l in " + init.token1_symbol + "-ref-frame = " +\
                        "{:1.4f}".format(session.token0_pl_token1) + ' ' + init.token1_symbol + ' or '+\
                        "{:1.2f}".format(session.token0_pl_token1 / NUM_INVESTED_TOKEN1_LP * 10000) + ' bp')
            else:
                if (not flag_failed_tx) and (not flag_unwind) and i <  main_loop_end - NUM_LP * MAX_ATTEMPS_FAILED_TX:
                    logger.info(network + ', current_price() failed, next main iteration...')
        ...
        if sum([sum(s) for s in session.success_tx_gas_fees]) >= MAX_SUCCESS_TX_GAS_USED or\
            ...
            session.report(Address, startBlockNumber, start_time, avg_price_mad, max_price_mad)
            logger.info('network, END session')
            return False
        ...
        if (not flag_unwind) and flag_increaseLiquidity and flag_hedgeRL and flag_decreaseLiquidity and flag_collect and flag_burn:
            ...
            if not flag_mint:
                ...
                while j < NUM_LP:
                    if priceLP[j] is None:
                        ...
                        #N.B. CHANGE_LP_POSITION_TO_INIT_PRICE needed because, if not, swapping restores the original amounts!
                        if CHANGE_LP_POSITION_TO_INIT_PRICE:
                            if LP_position_to_init_price[j] == 1:
                                ...
                                #N.B. Including the case when the previous LP[j] was ITM
                                elif tx_collected[j][1] * price >= tx_collected[j][0]:
                                    amount0_LP[j], amount1_LP[j] = 0., tx_collected[j][1]
                                else:
                                    #N.B. Change LP_position_to_init_price[j]
                                ...
                                #N.B. Including the case when the previous LP[j] was ITM
                                    ...
                                    LP_position_to_init_price[j] *= -1
                                    amount0_LP[j], amount1_LP[j] = 0., tx_collected[j][1]
                        else: #N.B. Needed because swapping restores the original amounts!
                            if LP_position_to_init_price[j] == 1:
                                amount0_LP[j], amount1_LP[j] = 0., NUM_INVESTED_TOKEN1_LP / NUM_LP
                            elif LP_position_to_init_price[j] == -1:
                                amount0_LP[j], amount1_LP[j] = price * NUM_INVESTED_TOKEN1_LP / NUM_LP, 0.
            ...
            if flag_LP_swap and priceLP[NUM_LP] is None and amount_to_swap_token0 != 0.:
                ...
                if amount_to_swap_token0 > 0:
                    if LP_SWAP_DISTANCE_TO_BOUND_PER == 0.:
                        if init.pool_fee == 500:
                            tickUpper[NUM_LP] = int(price_DECIMAL // 10 * 10 - 10)
                        elif init.pool_fee == 3000:
                            tickUpper[NUM_LP] = int(price_DECIMAL // 60 * 60 - 60)
                        elif init.pool_fee == 10000:
                            tickUpper[NUM_LP] = int(price_DECIMAL // 200 * 200 - 200)
                    else:
                ...
                #N.B. Can use amount_to_swap_token0 sign because this is immediately after amount_to_swap_token0 was set up!
                    ...
                    if LP_SWAP_DISTANCE_TO_BOUND_PER == 0.:
                        if init.pool_fee == 500:
                            tickLower[NUM_LP] = int(price_DECIMAL // 10 * 10 + 20)
                        elif init.pool_fee == 3000:
                            tickLower[NUM_LP] = int(price_DECIMAL // 60 * 60 + 120)
                        elif init.pool_fee == 10000:
                            tickLower[NUM_LP] = int(price_DECIMAL // 200 * 200 + 400)
                    else:
            ...
            ##########################
            #N.B. mint_condition[]
            logger.info(network + ", determine mint_condition:")
            if flag_mint:
                ...
                #N.B. conventional LP-s
                #N.B. do not initiate conventional LP-s in the last iterations
                if i >= int(RUNTIME_SEC / DELAY_LOOP_SEC) - NUM_LP * MAX_ATTEMPS_FAILED_TX:
                    #logger.info('')
                    logger.info(network + ", NO conventional LPs because end-of-runtime is reached: i >= " +\
                    ...
                    while j < NUM_LP:
                        if priceLP[j] is None:
                            ...
                            #N.B. Do not initiate conventional LPs with the wrong  LP_position_to_init_price in the last quarter of RUNTIME_SEC / DELAY_LOOP_SEC!
                            ...
                            #N.B. Do not initiate conventional LPs if abs(signed_token1_quantity) is too large or Cefi price too different &
                            ...
                            if EVENT_LOGS and len(pool_liquidity_list) > 0:
                                if blockNumber_init is None:
                                    if i != 0 and LP_position_to_init_price[j] * signed_token1_quantity * price / pool_liquidity_list[-1] *\
                                        10 ** (0.5 * (init.token0_decimal + init.token1_decimal)) < MAX_INIT_TOKEN1_VALUE_TO_POOL_LIQUIDITY_BP / 10000:
                                        blockNumber_init, price_init = block_num, price
                                        logger.info(network + ", blockNumber_init = " + str(blockNumber_init) + ", price_init = " +\
                                            "{:1.5f}".format(price_init) + ", scaled LP_position_to_init_price[j] * signed_token1_quantity * price / pool_liquidity_list[-1] = " +\
                                            "{:1.3f}".format(LP_position_to_init_price[j] * signed_token1_quantity * price / pool_liquidity_list[-1] * 10 ** (0.5 * (init.token0_decimal + init.token1_decimal)) * 10000) +\
                                            " < MAX_INIT_TOKEN1_VALUE_TO_POOL_LIQUIDITY_BP = " + str(MAX_INIT_TOKEN1_VALUE_TO_POOL_LIQUIDITY_BP))
                                    elif i != 0 and CEX_price is not None and price > 0. and\
                                            LP_position_to_init_price[j] * (CEX_price / price - 1) < MAX_INIT_RET_CEFI_DEFI_PER / 100:
                                        blockNumber_init, price_init = block_num, price
                                        logger.info(network + ", blockNumber_init = " + str(blockNumber_init) + ", price_init = " +\
                                            "{:1.5f}".format(price_init) + ", LP_position_to_init_price[j] * (CEX_price / price - 1) = " +\
                                            "{:1.3f}".format(LP_position_to_init_price[j] * (CEX_price / price - 1)) +\
                                            " < MAX_INIT_RET_CEFI_DEFI_PER / 100 = " + str(MAX_INIT_RET_CEFI_DEFI_PER / 100))
                                    else:
                    ...
                    #N.B. Do not initiate conventional LPs during quiet hours
                    if int(time.strftime('%w', time.localtime())) != 6 and int(time.strftime('%w', time.localtime())) != 0 and\
                         ...
                         mint_condition[:NUM_LP] = NUM_LP * [False]
                         logger.info(network + ", NO conventional mint during quiet hours!")

                    #N.B. Do not initiate conventional LPs if pool liquidity decreases < threshold * pool liquidity median!
                    if EVENT_LOGS and len(pool_liquidity_list) > 0 and\
                        ...
                        #logger.info('')
                        logger.info("NO conventional LPs because EVENT_LOGS=F or pool liq = " +\
                    ...
                    #N.B. Do not initiate conventional LPs if price_mad too high!
                    if price_mad > PRICE_MAD[0]: # and (time.time() - max_price_mad_time) / 60 >= PRICE_MAD_WAIT_TIME_MIN:
                        #logger.info('')
                        logger.info("NO conventional LPs because price_mad = " + "{:1.5f}".format(price_mad) + " > " + str(PRICE_MAD[0]) )
                        mint_condition[:NUM_LP] = NUM_LP * [False]

                    #N.B. Do not initiate conventional LPs if the potential mint() will exceed NUM_INVESTED_TOKEN1_LP
                    if sum(s[0] for s in session.collected) - sum(s[0] for s in session.invested) >= price * NUM_INVESTED_TOKEN1_LP or\
                        sum(s[1] for s in session.collected) - sum(s[1] for s in session.invested) >= NUM_INVESTED_TOKEN1_LP:
                        #logger.info('')
                        logger.info("NO conventional LPs because potential mint() amount = max(" +\
                            str((sum(s[0] for s in session.collected) - sum(s[0] for s in session.invested)) / price) + ", " +\
                            str(sum(s[1] for s in session.collected) - sum(s[1] for s in session.invested)) + ") will exceed NUM_INVESTED_TOKEN1_LP!" )
                        mint_condition[:NUM_LP] = NUM_LP * [False]
            

            #############################
            #N.B. mint(): only if mint_condition[j] (and not flag_unwind)
            if any(mint_condition) and (not flag_failed_tx):
                ...
                if GAS_EXT:
                    ...
                    if isinstance(result, tuple):
                        ...
                        logger.info(network + ", 99-th percentile gas from blocknative.com in mint(): max_fee_per_gas = " +\
            ...
            while j <= NUM_LP:
                ...
                if mint_condition[j]:
                    ...
                    if count_failed_tx < MAX_ATTEMPS_FAILED_TX:
                        ...
                        logger.info(network +', mint() attempted for LP[' + str(j) + '] with' +\
                           ' amount0_LP = ' + "{:1.3f}".format(amount0_LP[j] / 10**init.token0_decimal) +\
                           ', amount1_LP = ' + "{:1.3f}".format(amount1_LP[j] / 10**init.token1_decimal) +\
                            '), priceLower = ' + "{:1.3f}".format(priceLower[j] / 10**init.token0_decimal * 10**init.token1_decimal) +\
                            ', priceUpper = ' + "{:1.3f}".format(priceUpper[j] / 10**init.token0_decimal * 10**init.token1_decimal))
                        ...
                        if isinstance(result, tuple):
                            ...
                            if j < NUM_LP:
                                ...
                                session.token0_price_invested.append((amount0 / 10**init.token0_decimal, price, j))
                                session.token1_price_invested.append((amount1 / 10**init.token1_decimal, price, j))
                                if amount1 != 0:
                                ...
                                logger.info(network + ", LP[" + str(j) + "]:" +\
                                            ...
                                            ", priceLP = " + "{:1.3f}".format(priceLP[j] / 10**init.token0_decimal * 10**init.token1_decimal) +\
                                            ", priceLower = " + "{:1.3f}".format(priceLower[j] / 10**init.token0_decimal * 10**init.token1_decimal) +\
                                            ", priceUpper = " + "{:1.3f}".format(priceUpper[j] / 10**init.token0_decimal * 10**init.token1_decimal) )
                          
                            else:
                                session.count_LP_swap += 1
                                session.token0_price_invested.append((amount0 / 10**init.token0_decimal, price, -1))
                                session.token1_price_invested.append((amount1 / 10**init.token1_decimal, price, -1))
                                logger.info(network  + ", LP[" + str(j) + "]:" +\
                            ...
                            #N.B. run current_price() again only if mint() succeeds (otherwise the price is updated at the beginning of the next iteration
                            #N.B. the fuction returns False if no updates!
                            result = current_price(network, block_num, CEX_price_list, price_list, price_list_median, pool_liquidity_list, pool_liquidity_median,\
                                price_mad, pos_price_mad, avg_price_mad, max_price_mad, priceLower, priceUpper, swap_volume_token1, rel_swap_volume_token1, swap_flow_token1, PRICE_ALCHEMY, init=init)      
                            if isinstance(result, list):
                                GMTtimeStamp, block_num, txIx, CEX_price_list, CEX_size, CEX_bid, CEX_ask, price_list, price_list_median, pool_liquidity_list, pool_liquidity_median, signed_token1_quantity,\
                                    price_mad, pos_price_mad, avg_price_mad, max_price_mad, swap_volume_token1_output, rel_swap_volume_token1_output, swap_flow_token1_output = result
        ...
        ###################################################################################
        #4. Log-reporting
        #N.B. Determine unwind_distance_to_bound at every iteration because NUM_LP can change!
        unwind_distance_to_bound = [(- lp_bound_distance_to_current_per / 100 - (k + 1) * LP_UNWIND_DISTANCE_TO_LOWER_BOUND_DECREASE_PER / 100, \
                                    LP_UNWIND_DIST_TO_UPPER_BOUND_PER) if LP_position_to_init_price[k] == 1 else\
                                    (LP_UNWIND_DIST_TO_UPPER_BOUND_PER,\
                                    - lp_bound_distance_to_current_per / 100 - (k + 1) * LP_UNWIND_DISTANCE_TO_LOWER_BOUND_DECREASE_PER / 100) \
        ...
        logger.info('')
        if priceLP != ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None]:
            if not flag_failed_tx:
                j = 0
                while j <= NUM_LP: # and i < int(RUNTIME_SEC / DELAY_LOOP_SEC) - NUM_LP * MAX_ATTEMPS_FAILED_TX:
                    ...
                    if priceLower[j] is not None and priceUpper[j] is not None and priceLP[j] is not None:
                        ...
                        #N.B. swap_volume_token1[j] & rel_swap_volume_token1[j] are computed in current_price(), using priceLower, priceUpper
                        ...
                        #logger.info('')
                        logger.info(network + ", LP[" + str(j) + "], tokenId=" + str(tokenIds[j]) +\
            ...
            logger.info(network + ", determine unwind_condition:")
            if flag_unwind:
                unwind_condition = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [True]
            #N.B. Unwind LP-s during quiet hours
            elif (int(time.strftime('%w', time.localtime())) != 6 and int(time.strftime('%w', time.localtime())) != 0 and\
                        ((int(time.strftime('%H', time.localtime())) >= QUIET_HOURS_START[0] and int(time.strftime('%H', time.localtime())) < QUIET_HOURS_END[0]) or\
                        (int(time.strftime('%H', time.localtime())) >= QUIET_HOURS_START[1] and int(time.strftime('%H', time.localtime())) < QUIET_HOURS_END[1]))):
                unwind_condition = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [True]
                logger.info(network + ", UNWIND all non-swap LP positions during quiet hours!")
            #N.B. Last iterations are reserved for unwinding conventional swaps
            elif i >= int(RUNTIME_SEC / DELAY_LOOP_SEC) - NUM_LP * MAX_ATTEMPS_FAILED_TX:
                logger.info('')
                ...
                unwind_condition = ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [False]
                if flag_mint:
                    ...
                    #N.B. non-swap LP-s: still under 'not flag_failed_tx'; othewise 'unwind_condition' is not touched!
                    j = 0
                    while j < NUM_LP:
                        #N.B. raise unwind_condition only if there is an actual LP j-th position!
                        if priceLP[j] is not None and priceLower[j] is not None and priceUpper[j] is not None:

                            #N.B. If ITM: this condition causes losses for OTM positions!
                            #if price_DECIMAL >= priceLower[j] and price_DECIMAL <= priceUpper[j]:
                            ...
                            if price_mad > PRICE_MAD[-1]:
                                ...
                                #N.B. No LP swap!
                                count_LP_swap_attempts = LP_SWAP_MAX_ATTEMPTS_FAILED_TX

                            #N.B. price return between Cefi and Defi is too large
                            if CEX_price is not None and price > 0. and\
                                    LP_position_to_init_price[j] * (CEX_price / price - 1) > MAX_UNWIND_RET_CEFI_DEFI_PER / 100:
                                logger.info('')
                                logger.info(network + ", UNWIND LP[" + str(j) + "] position with tokenId = " + str(tokenIds[j]) +\
                                            " because CEX_price = " + "{:1.2f}".format(CEX_price) + ", price = " + "{:1.2f}".format(price) +\
                                            ", and LP_position_to_init_price[j] * (Cefi_price / Defi_price - 1) > MAX_UNWIND_RET_CEFI_DEFI_PER / 100 = " + str(MAX_UNWIND_RET_CEFI_DEFI_PER / 100))
                                unwind_condition[j] = True
                                session.count_unwind_max_cefi_price_ret += 1
                                #N.B. No LP swap!
                                count_LP_swap_attempts = LP_SWAP_MAX_ATTEMPTS_FAILED_TX

                            #N.B. token1 signed swap quantity too large but only for the LP position before last or before tokenIds = None
                            if EVENT_LOGS and LP_position_to_init_price[j] * signed_token1_quantity * price / pool_liquidity_list[-1]  *\
                            ...
                            if EVENT_LOGS and pool_liquidity_list[-1] < pool_liquidity_LP * MIN_POOL_LIQUIDITY_PER[-1] / 100:
                                ...
                                logger.info(network + ", UNWIND LP[" + str(j) + "] position with tokenId = " + str(tokenIds[j]) +\
                                            " because pool liq = " +\
                                            "{:1.0f}".format(pool_liquidity_list[-1] / 10 ** (0.5 * (init.token0_decimal + init.token1_decimal))) +\
                                            " < threshold * initiation LP pool liq = " + str(MIN_POOL_LIQUIDITY_PER[-1] / 100) + " * " +\
                            ...
                            if 1. - priceLower[j] / price_DECIMAL <= unwind_distance_to_bound[j][0]:
                                ...
                                unwind_condition[j] = True
                                #N.B. Flip the position of LP to current price
                    ...
                    if flag_LP_swap:
                        ...
                        if amount0_LP[NUM_LP] is not None and amount0_LP[NUM_LP] > 0:
                            #N.B. unwinding successfull LP swap (price is small enough): token0 is converted into token1
                            ...
                            if flag_unwind or (LP_SWAP_UNWIND_DISTANCE_PER == LP_SWAP_DISTANCE_TO_BOUND_PER and\
                               ...
                               (LP_SWAP_UNWIND_DISTANCE_PER > LP_SWAP_DISTANCE_TO_BOUND_PER and\
                                ...
                                if flag_unwind:
                                    ...
                                    " because flag_unwind = True; count_LP_swap_attempts = " + str(count_LP_swap_attempts))
                                elif LP_SWAP_UNWIND_DISTANCE_PER == LP_SWAP_DISTANCE_TO_BOUND_PER:
                                    logger.info(network + ", UNWIND failing LP[" + str(NUM_LP) + "] swap with tokenId = " + str(tokenIds[NUM_LP]) +\
                                    " because price = " + str(price) + " > priceUnwind = " +\
                                    str(priceUnwind / 10**init.token0_decimal * 10**init.token1_decimal) +\
                                   ...
                                   " because price = " + str(price) + " is LP_SWAP_UNWIND_DISTANCE_PER / 100 = " + str(LP_SWAP_UNWIND_DISTANCE_PER / 100) + "%" +\
                                    ...
                                    "; count_LP_swap_attempts = " + str(count_LP_swap_attempts))
                                #N.B. Remove the last tuple in .tokenX_price_invested with tuple[-1] == -1 because there can be at most 1 LP swap at a time
                                if [s for s in session.token0_price_invested if s[-1] == -1] != []:
                                    session.token0_price_invested.remove([s for s in session.token0_price_invested if s[-1] == -1].pop(-1))
                                if [s for s in session.token1_price_invested if s[-1] == -1] != []:
                                    session.token1_price_invested.remove([s for s in session.token1_price_invested if s[-1] == -1].pop(-1))
                                unwind_condition[NUM_LP] = True
                              
                        #N.B. Need higher price!
                        if amount1_LP[NUM_LP] is not None and amount1_LP[NUM_LP] > 0.:
                            #N.B. unwinding successfull LP swap (price is big enough):  token1 is converted into token0
            ...
            ###########################################################################
            #N.B. decreaseLiquidity(), collect(), burn(): only if unwind_condition[j] and priceLP[j] is not None
            #N.B. "if flag_mint" because if mint() fails, j becomes too large here and mint_condition[j] = True fails with error "list assignment index out of range"!
            if unwind_condition != ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [False] and (flag_mint or flag_unwind):
                #N.B. gas fees
                if not flag_failed_tx:
                    max_fee_per_gas, max_priority_fee_per_gas = MAX_FEE_PER_GAS, MAX_PRIORITY_FEE_PER_GAS
                    if GAS_EXT:
                        ...
                        if isinstance(result, tuple):
                            max_fee_per_gas, max_priority_fee_per_gas = result
                            logger.info(network + ", 99-th percentile gas from blocknative.com in decreaseLiquidity() & collect(): max_fee_per_gas = " +\
                                "{:1.2f}".format(max_fee_per_gas) + ' Gwei' +\
                                ', max_priority_fee_per_gas = ' +\
                                "{:1.2f}".format(max_priority_fee_per_gas) + ' Gwei')
                            max_fee_per_gas, max_priority_fee_per_gas = int(max_fee_per_gas * 1e9),\
                ...
                if flag_increaseLiquidity and flag_hedgeRL and flag_collect and flag_burn:
                    if flag_decreaseLiquidity or flag_unwind:
                        j = 0
                    while j <= NUM_LP:
                        if unwind_condition[j] and priceLP[j] is not None:
                            if tokenIds[j] is None:
                                logger.error(network + ', in decreaseLiquidity(), tokenId[' + str(j) +\
                                                            '] is None although priceLP[' + str(j) + '] = ' + str(priceLP[j]) + ' is not None? Break NUM_LP loop...')
                                break
                            #N.B. Get liquidity of tokenIds[j]
                            try:
                ...
                if flag_increaseLiquidity and flag_hedgeRL and flag_decreaseLiquidity and flag_burn:
                    if flag_collect or flag_unwind:
                        j = 0
                    while j <= NUM_LP:
                        if unwind_condition[j] and priceLP[j] is not None:
                            if tokenIds[j] is None:
                                logger.error(network + ', in collect(), tokenId[' + str(j) +\
                                                            '] is None although priceLP[' + str(j) + '] = ' + str(priceLP[j]) + ' is not None? Break NUM_LP loop...')
                                break
                            ...
                            if count_failed_tx < MAX_ATTEMPS_FAILED_TX:
                                ...
                                if isinstance(result, tuple):
                                    ...
                                    if j < NUM_LP:
                                        ...
                                        #N.B. session
                                        session.token0_price_collected.append((amount0 / 10**init.token0_decimal, price, j))
                                        session.token1_price_collected.append((amount1 / 10**init.token1_decimal, price, j))
                                        ...
                                        session.avg_LP_duration[j] = (session.avg_LP_duration[j] * (session.count_LP_swap - 1) +\
                                                                            (decreaseLiquidity_time[j] - mint_time[j]) ) / session.count_LP_swap
                                        session.avg_ITM_duration[j] = (session.avg_ITM_duration[j] * (session.count_LP_swap - 1) +\
                                                                    ITM_duration[j]) / session.count_LP_swap
                                        session.avg_OTM_duration[j] = (session.avg_OTM_duration[j] * (session.count_LP_swap - 1) +\
                                                                    OTM_duration[j]) / session.count_LP_swap
                                        priceUnwind = None
                                        #N.B. flag_LP_swap = True is used as a proxy for failed LP swap:
                                        if not flag_LP_swap:
                                            session.token0_price_collected.append((amount0 / 10**init.token0_decimal, price, -1))
                                            session.token1_price_collected.append((amount1 / 10**init.token1_decimal, price, -1))
        ...
        #N.B. swap() is before burn() for speed of swapping; 
        ...
        if flag_increaseLiquidity and flag_hedgeRL and flag_decreaseLiquidity and flag_collect and flag_burn:
            logger.info('') 
            logger.info(network + ", determine swap_condition:")
            #swap_condition
            swap_condition = False
            #N.B. failed LP swap or no LP swap
            if flag_LP_swap and (count_LP_swap_attempts >= LP_SWAP_MAX_ATTEMPTS_FAILED_TX or\
                ...
                if count_LP_swap_attempts >= LP_SWAP_MAX_ATTEMPTS_FAILED_TX:
                    logger.info(network + ", LP swap tx failed " +\
                           str(count_LP_swap_attempts) + " times, conventional swap is executed with amount_to_swap_token0 determined below!")
                #N.B. If the end of main loop, conventional swap is executed!
                if i == main_loop_end - MAX_ATTEMPS_FAILED_TX:
                    logger.info(network + ", LP swap tx with tokenId = " + str(tokenIds[-1]) + " failed because iterations reached main_loop_end" +\
                            ", conventional swap is executed with amount_to_swap_token0 determined below!")
            ...
            #N.B. "if flag_mint" is required here, because otherwise swap can be run after failed mint() of conventional LP!
            if flag_mint:
                #N.B. session swap first: overwrites tx batch swap because amount_to_swap_token0 includes tx_batch_amount_to_swap_token0
                amount_to_swap_token0 = sum(s[0] for s in session.collected) - sum(s[0] for s in session.invested)
                if abs(amount_to_swap_token0) >= MIN_SESSION_SWAP_PER / 100 * NUM_INVESTED_TOKEN1_LP * price or\
                    ...
                    logger.info(network + ", NO session swap_condition = " + str(swap_condition) + ": abs(amount_to_swap_token0) = " +\
                            "{:1.2f}".format(abs(amount_to_swap_token0)) +\
                    ...
                    if abs(tx_batch_amount_to_swap_token0) >= MIN_TX_BATCH_SWAP_PER / 100 * NUM_INVESTED_TOKEN1_LP * price:
                        ...
                        logger.info(network + ", NO tx batch swap_condition =  " + str(swap_condition) + " either: abs(tx_batch_amount_to_swap_token0) = " +\
            ...
            #N.B. if CHANGE_LP_POSITION_TO_INIT_PRICE, swaps maybe needed only at the end
            if CHANGE_LP_POSITION_TO_INIT_PRICE:
                swap_condition = swap_condition and i >= int(RUNTIME_SEC / DELAY_LOOP_SEC)

            #swap
            if swap_condition:
                if abs(amount_to_swap_token0) >= SWAP_EPSILON_PER / 100  * NUM_INVESTED_TOKEN1_LP * price:
                    logger.info(network + ", swap, because swap_condition = True with amount_to_swap_token0 = " +\
                    ...
                    #conventional swap
                        ...
                        #N.B. gas fees
                        if not flag_failed_tx:
                            max_fee_per_gas, max_priority_fee_per_gas = int(INIT_SWAP_MULT_GAS_FACTOR_REPLACE * MAX_FEE_PER_GAS),\
                                                                        int(INIT_SWAP_MULT_GAS_FACTOR_REPLACE * MAX_PRIORITY_FEE_PER_GAS)
                            if GAS_EXT:
                                result = current_gas(network)
                                if isinstance(result, tuple):
                                    max_fee_per_gas, max_priority_fee_per_gas = result
                                    logger.info(network + ", INIT_SWAP_MULT_GAS_FACTOR_REPLACE * 99-th percentile of gas from blocknative.com in swap(): max_fee_per_gas = " +\
                                       str(INIT_SWAP_MULT_GAS_FACTOR_REPLACE) + ' * ' + '{:1.2f}'.format(max_fee_per_gas) + ' Gwei' +\
                                        ', max_priority_fee_per_gas = ' +\
                                       str(INIT_SWAP_MULT_GAS_FACTOR_REPLACE) + ' * ' + "{:1.2f}".format(max_priority_fee_per_gas) + ' Gwei')
                                    max_fee_per_gas, max_priority_fee_per_gas = int(INIT_SWAP_MULT_GAS_FACTOR_REPLACE * max_fee_per_gas * 1e9),\
                                                                                int(INIT_SWAP_MULT_GAS_FACTOR_REPLACE * max_priority_fee_per_gas * 1e9)
                                else:
                                    logger.info(network + ", use hard-coded gas: max_fee_per_gas = " + "{:1.2f}".format(max_fee_per_gas / 1e9) + ' Gwei'\
                                        ', max_priority_fee_per_gas = ' + "{:1.2f}".format(max_priority_fee_per_gas / 1e9) + ' Gwei')
                        ...
                        if isinstance(result, tuple):
                            ...
                            session.collected[NUM_LP] = tuple(map(sum, zip(session.collected[NUM_LP], (-amount_to_swap_token0, amount_to_swap_token0 / price))))
                            if amount_to_swap_token0 > 0:
                                session.conventional_swapped = tuple(map(sum, zip(session.conventional_swapped, (amount_to_swap_token0, 0.))))
                            elif amount_to_swap_token0 < 0:
                                session.conventional_swapped = tuple(map(sum, zip(session.conventional_swapped, (0., -amount_to_swap_token0))))
                            session.token0_price_collected.append((-amount_to_swap_token0, price, -1))
                            session.token1_price_collected.append((amount_to_swap_token0 / price, price, -1))
                            amount_to_swap_token0 = 0.
                            session.count_conventional_swaps += 1
                            ...
                            logger.info(network + ", conventional swap slippage & pool fee cost = " +\
                                            ...
                                            #"; tx swap flow token1 = " + "{:1.1f}".format(swap_flow_token1))
                            #N.B. session
                            session.swap_cost_token1 += slippage_and_pool_fee_token1
                            ...
                            logger.info(network + ', session: count conventional swaps=' + str(session.count_conventional_swaps) +\
                                        #" i) " + "{:1.2f}".format(session.token1_rf_pl_bp[j]) + " bp"  +\
                                        ", swap cost = " + "{:1.1f}".format(slippage_and_pool_fee_token1) + ' ' + init.token1_symbol +\
                                        " or " + "{:1.1f}".format(session.swap_cost_bp) + " bp")
                        else:
        ...
        ########################################################################
        #8. log-reporting p&l for all trades
        if flag_increaseLiquidity and flag_hedgeRL and flag_decreaseLiquidity and flag_collect and flag_burn:
            if unwind_condition != ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [False] and i <= int(RUNTIME_SEC / DELAY_LOOP_SEC):
                session.report(Address, startBlockNumber, start_time, avg_price_mad, max_price_mad)
    
        
        #########################################################################
        #9. burn(): otherwise the NFT (corresponding to the LP) stays in the wallet & can be seen when running current_LP_positions()
        ...
        if flag_increaseLiquidity and flag_hedgeRL and flag_decreaseLiquidity and flag_collect:
            if unwind_condition != ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [False] and\
                tokenIds != ((MAX_TIMES_INCREASE_NUM_LP + 1) * NUM_LP + 1) * [None] and (flag_mint or flag_unwind):
                logger.info('')
                #N.B. gas fees
                if not flag_failed_tx:
                    max_fee_per_gas, max_priority_fee_per_gas = MAX_FEE_PER_GAS, MAX_PRIORITY_FEE_PER_GAS
                    if GAS_EXT:
                        ...
                        if isinstance(result, tuple):
                            max_fee_per_gas, max_priority_fee_per_gas = result
                            logger.info(network + ", 99-th percentile gas from blocknative.com in burn(): max_fee_per_gas = " +\
                                "{:1.2f}".format(max_fee_per_gas) + ' Gwei' +\
                                ', max_priority_fee_per_gas = ' +\
                                "{:1.2f}".format(max_priority_fee_per_gas) + ' Gwei')
                            max_fee_per_gas, max_priority_fee_per_gas = int(max_fee_per_gas * 1e9),\
                ...
                if flag_burn or flag_unwind:
                    j = 0
                while j <= NUM_LP:
                    if priceLP[j] is None and tokenIds[j] is not None:
