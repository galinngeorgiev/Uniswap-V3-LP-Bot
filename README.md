Change the DATA_PATH string in global_params.py to the desired path (using Windows requires double-slash). Run (from console): python "C:\...\UniswapV3_LP\main.py" polygon
